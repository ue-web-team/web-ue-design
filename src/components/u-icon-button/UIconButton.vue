...
button.outline-type {
  ...
  &.primary {
    ...
    &:hover, &.hover {
      @apply bg-evergreen/20 text-black dark:bg-sun/20 dark:text-white dark:border-sun;
    }
    &:active, &.active {
      @apply bg-evergreen text-white dark:bg-sun dark:text-black dark:border-sun;
    }
  }
   ...
   &.light-variant {
    ...
    &:active, &.active {
     @apply  bg-sun text-black border-sun;
    }
  }
