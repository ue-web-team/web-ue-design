<template>
  ...
  <span v-if="loading" class="mr-2 animate-spin"><i-mdi-loading /></span>
...
const buttonClasses = computed(() => {
  return [
    ...
    'focus-style min-h-11 inline-flex items-center relative overflow-hidden transition-colors duration-300 px-4 py-2 font-semibold !disabled:(bg-gray-200 border-gray-400 text-gray-500)',
  ]
})
