...
input[type="checkbox"] {
  @apply relative w-9 h-5 rounded-xl border-2 border-evergreen cursor-pointer
  block appearance-none origin-center disabled:opacity-60 disabled:filter disabled:grayscale;
